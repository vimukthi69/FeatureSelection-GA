...
# Training Logistic Regression model on PCA-reduced features
...
# Training SVM model on PCA-reduced features
...
# Training logistic regression model without feature selection
...
# Training SVM model without feature selection
